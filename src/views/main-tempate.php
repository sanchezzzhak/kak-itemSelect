...
<?= Html::beginTag('div', $context->options); ?>
    <div class="col-xs-12 col-md-5">
        ...
        <?php if ($context->searchFilter): ?>
            <div class="itemselect-input-search"
                 data-search=".itemselect-list-from"><?= Html::input('text', '', '', $context->searchFilterOptions) ?></div>
        <?php endif; ?>
        <div><a href="javascript:;" data-role="select-all-to"><?=$context->labelSelectAll?></a></div>
    ...
    <div class="col-xs-12 col-md-5">
        ...
        <?php if ($context->searchFilter): ?>
            <div class="itemselect-input-search"
                 data-search=".itemselect-list-to"><?= Html::input('text', '', '', $context->searchFilterOptions) ?></div>
        <?php endif; ?>
        <div><a href="javascript:;" data-role="select-all-from"><?=$context->labelSelectAll?></a></div>
